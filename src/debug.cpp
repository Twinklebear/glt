...
#ifdef _WIN32
void APIENTRY glt::dbg::debug_callback(GLenum src, GLenum type, GLuint id, GLenum severity,
	GLsizei len, const GLchar *msg, const GLvoid*)
{
	log_debug_msg(src, type, id, severity, len, msg);
}
#else
void glt::dbg::debug_callback(GLenum src, GLenum type, GLuint id, GLenum severity,
	GLsizei len, const GLchar *msg, const GLvoid*)
{
	log_debug_msg(src, type, id, severity, len, msg);
}
#endif
void glt::dbg::log_debug_msg(GLenum src, GLenum type, GLuint, GLenum severity, GLsizei, const GLchar *msg){
